<nav class="bg-primary text-white shadow-lg border-b border-secondary/20" x-data="{ open: false }">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-3">
                <a href="/" class="flex items-center space-x-3">
                    ...
                    <img src="{{ asset('images/kuppet-logo.jpg') }}" alt="KUPPET Logo" class="h-10 w-auto">
            ...
            <ul class="hidden md:flex items-center space-x-8 font-semibold text-sm">
                ...
                <li>
                    <a href="/" class="hover:text-secondary transition duration-200">
                        Home
                    </a>
                </li>

                <li>
                    <a href="/updates" class="hover:text-secondary transition duration-200">
                        Updates
                    </a>
                </li>

                <li>
                    <a href="/branch" class="hover:text-secondary transition duration-200">
                        Branch Leadership
                    </a>
                </li>

                <li>
                    <a href="/resources" class="hover:text-secondary transition duration-200">
                        Teacher Resources
                    </a>
                </li>

                <li>
                    <a href="/contact" class="hover:text-secondary transition duration-200">
                        Contact
                    </a>
                </li>
    ...
    <div x-show="open" x-transition @click.outside="open=false"
        ...
        <ul class="flex flex-col space-y-4 px-6 py-6 font-semibold text-sm">
            ...
            <li class="pt-2">
                <a href="/member-support" class="block text-center bg-secondary text-primary py-2 rounded-lg font-bold">
                    Get Support
                </a>
            </li>
            ...
            @guest
                <li>
                    <a href="" class="block text-center border border-white py-2 rounded-lg">
                        Login
                    </a>
                </li>
            @endguest
            ...
            @auth
                ...
                <li>
                    <a href="/dashboard" class="hover:text-secondary transition">
                        Dashboard
                    </a>
                </li>
